" Vim syntax file for Expect language
" Language:	Expect
" Maintained:	Tcl/Tk by SM Smithfield <m_smithfield@yahoo.com>
" Maintainer:   Expect by Ralph Jennings <knowbudy@oro.net>
...
" -------------------------
" see Note in :h /\@=
syn match tclKeywordGroup contained "\([^\[{ ]\)\@<!\w\+" contains=@tclKeywords,@tkKeywords,@expectKeywords
...
" Clusters:
" -------------------------
syn cluster tcltkKeywords      contains=@tclKeywords,@tkKeywords,@expectKeywords
...
syn cluster expectKeywords     contains=expectVariables,expectCommand,expectStatement,expectExpectOpts,expectOutVar
" ------------------
