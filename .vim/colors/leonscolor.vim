...
highlight Cursor        term=reverse      ctermfg=green ctermbg=yellow                      guifg=#000000 guibg=#559955
highlight CursorIM      term=reverse      ctermfg=black ctermbg=darkgreen                 guifg=#000000 guibg=#336633
highlight CursorColumn  term=none         ctermbg=darkyellow                                guibg=#333366
highlight CursorColumn  term=none         ctermbg=darkyellow                                guibg=#333366
highlight Comment       term=italic       ctermfg=darkcyan ctermbg=black                  guifg=#00a594
highlight Constant      term=underline    ctermfg=yellow                                    guifg=#0099dd
...
highlight SpellBad      term=reverse      cterm=underline ctermfg=red ctermbg=black       gui=none 
highlight SpellCap      term=reverse      cterm=underline ctermfg=yellow ctermbg=black    gui=none
highlight SpellLocal    term=reverse      cterm=underline ctermfg=yellow ctermbg=black      gui=none
highlight SpellRare     term=reverse      cterm=underline ctermfg=darkgreen ctermbg=black gui=none
highlight Statement     term=standout     ctermfg=red                                 guifg=#ac0000
highlight StatusLine    term=reverse      ctermfg=darkgreen ctermbg=black                 gui=none guibg=#228822 guifg=#000000
highlight StatusLineNC  term=reverse      ctermfg=darkgreen ctermbg=yellow                  gui=none guibg=#336633 guifg=#000000
...
highlight WildMenu      term=reverse      ctermfg=yellow ctermbg=darkgreen                  guifg=#000099 guibg=#00ac00   
